...
import { User, LogOut, Plus, Edit3, Bookmark, Zap, AlertCircle, CheckCircle2, Trash2, Check, Moon, Sun } from 'lucide-react';
import TimeInput from './TimeInput';

const AdminPanel = ({ user, handleLogout, queue, deleteItem, clearQueue, editItem, handleSave, formData, setFormData, isEditing, errorMessage, formatTime, handleComplete, handleSetOvernight, handleCancelOvernight }) => {
